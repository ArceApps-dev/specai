...
|-------------------|----------------------|
| `delegate(prompt, agent="implementer")` | `@generalist` with the filled `implementer-prompt.md` template |
| `delegate(prompt, agent="spec-reviewer")` | `@generalist` with the filled `spec-reviewer-prompt.md` template |
| `delegate(prompt, agent="final-reviewer")` | `@generalist` with the filled review prompt |
| `delegate(prompt, agent="code-quality-reviewer")` | `@generalist` with the filled `code-quality-reviewer-prompt.md` template |
